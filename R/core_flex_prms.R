...
validate_flex_prms <- function(flex_prms_obj) {
  ...
  internal_list <- check_internal_list(
    internal_list = internal_list,
    prm_names = prm_names,
