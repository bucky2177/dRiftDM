...
log_posterior_lower <- function(
  ...
  if (!is.null(all_phis_mat)) {
    ...
    log_priors_mat <- sapply(seq_along(thetas_names), function(theta_idx) {
      drift_dm_supr_warn(
        {
          log_prior_lower_funs[[thetas_names[theta_idx]]](
...
#' @keywords internal
get_default_prior_settings <- function(
  drift_dm_obj,
  level,
  means = NULL,
  sds = NULL,
